...
Template.layout.onRendered(function(){
    ...
    var tourItems =     [
        ...
        ["addPhoto","top left","bottom center","Add Photo","Clicking this button allows you to add photos to your problem."],
        ...
        ["sendOut","top center","bottom center","Share Problem","This button shares your problem so that other people can help you solve it"]
    ]
        createTourItem(tourItems[0][0],tourItems[0][1],tourItems[0][2],tourItems[0][3],tourItems[0][4],1,-1,tourItems);
        createTourItem(tourItems[0][0],tourItems[0][1],tourItems[0][2],tourItems[0][3],tourItems[0][4],1,-1,tourItems);
    });